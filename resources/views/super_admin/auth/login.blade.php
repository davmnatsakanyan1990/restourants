...
<div class="logo">
    {{--<a href="index.html">--}}
        {{--<img src="/admin/img/logo-big.png" alt=""/>--}}
    {{--</a>--}}
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" action="{{ url('super_admin/login') }}" method="post">
        {{ csrf_field() }}
        <h3 class="form-title">Super Admin Login</h3>
        @if(count($errors) > 0)
...
<script src="/admin/plugins/jquery-validation/dist/jquery.validate.min.js" type="text/javascript"></script>
<script type="text/javascript" src="/admin/plugins/select2/select2.min.js"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="/admin/scripts/core/app.js" type="text/javascript"></script>
<script src="/admin/scripts/custom/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
