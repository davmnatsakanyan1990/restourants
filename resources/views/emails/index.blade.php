...
<head>
    ...
    <style>
        ...
        .content .top-title-block .top-info-block {
            width: 600px;
            margin: 24px auto 0;
            padding: 5px 0 0 0;
            text-align: center;
        ...
        .content .top-title-block .top-info-block:after {
            content: "";
            display: block;
            position: absolute;
            left: 0;
        ...
        .content .login-information-block {
            text-align: center;
            margin: 50px 0 0 0;
        }

        .content .login-information-block h2 {
            font-size: 22px;
            line-height: 22px;
            margin: 0;
            padding: 0;
        ...
        .content .login-information-block ul {
            display: inline-block;
            text-align: left;
        }

        .content .login-information-block ul li {
            display: block;
            list-style: none;
            margin: 0 0 12px 0;
        }

        .content .login-information-block ul li:last-child span:last-child {
            border-bottom: 0;
        }

        .content .login-information-block ul li:after {
            content: "";
            display: table;
            clear: both;
        }
        ...
        .content .login-information-block button {
            font-size: 14px;
